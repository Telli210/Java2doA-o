...
public class Principal {
	...
	private static int menu(Scanner entrada) {
		...
		opcion = Helper.validarEnteroEnRango(entrada, "Rango", 1, 3);
		return opcion;
	}
	...
	private static void mostrarCantTrabajosMayor(Scanner entrada, Queue<trabajoImpresion> colaAuxiliar) {
		...
		System.out.println(
				"Se mostrara la cantidad de trabajos, cuya cantidad de páginas sea mayor o igual a un valor ingresado");
		...
		System.out.println(
				"La cantidad de trabajos impresos con una cantidad de paginas mayor o igual al valor ingresado es: "
						+ contTrabajosMayor);
	}
