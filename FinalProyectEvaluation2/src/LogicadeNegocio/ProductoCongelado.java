...
public class ProductoCongelado extends Producto implements Serializable{
	...
	public String toString() {
		return "ProductoCongelado [CodigodelProducto=" + getCodigodelProducto() + ", Descripcion="
				+ getDescripcion() + ", FechaVencimiento=" + getFechaVencimiento() + ", NumeroLote="
				+ getNumeroLote() + ", CostoTratamiento=" + getCostoTratamiento() + "]";
	}
}
